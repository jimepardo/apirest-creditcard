...
LOCK TABLES `brand_type` WRITE;
/*!40000 ALTER TABLE `brand_type` DISABLE KEYS */;
INSERT INTO `brand_type` VALUES (1,'VISA'),(2,'NARA'),(3,'AMEX');
/*!40000 ALTER TABLE `brand_type` ENABLE KEYS */;
UNLOCK TABLES;
